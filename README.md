...
The original notebook is written with MIMIC-III filenames and columns even
though the model accepts `--dataset mimic4`. This repository now includes a
schema adapter and a MIMIC-IV run configuration:
